...
## Abundance Prediction Figures

### Central Pacific Region

```{r}
#| echo: false
img <- file.path(local_wd, "output","cenpac_abund.png")
...
```{r}
#| echo: false
img <- file.path(local_wd, "output","assess_abund.png")
knitr::include_graphics(img)
```
...
### Abundance prediction results using only previous data
```{r}
#| echo: false
#| message: false
tab <- read_csv(file.path(local_wd,"output","previous_data","N_summ.csv"))
tab
```
