...
**Note!!!** *Currently this is the way that our team downloaded oceanographic model data from [Copernicus Marine Service](https://marine.copernicus.eu/). This more complicated method was necessary because the `CopernicusMarine`[package](https://pepijn-devries.github.io/CopernicusMarine/) did not have the ability to download ocean product data subsets. However, as of September 2025 this capability was repaired. So, the `CopernicusMarine` package* *is probably a more efficient way to download the data, and we will investigate this further.*
